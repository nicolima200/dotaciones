...
export type RoleType = 'garita' | 'caminante' | 'movil' | 'motorizada' | 'correo' | 'orden_servicio' | 'comision' | 'disponible' | 'no_disponible' | 'ausente' | 'vacaciones' | 'ofl_control' | 'ofl_servicio' | 'operaciones' | 'ayte_guardia' | 'logistica' | 'personal' | 'judiciales' | 'montada' | 'jefe' | 'segundo_jefe';
